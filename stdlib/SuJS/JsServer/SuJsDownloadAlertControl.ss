...
Controller
	...
	CallClass(tasks)
		...
		Suneido.SuJsDownloadAlertWindow = ModalWindow(Object(this, tasks),
			title: 'Outstanding Downloads', keep_size: false, closeButton?: false)
		FlashWindowEx(Object(hwnd: Suneido.SuJsDownloadAlertWindow.Hwnd,
	...
	Refresh()
		{
		.Update(ServerEval('SuJsDownload.CheckTask', Suneido.User))
		}
	...
	On_Cancel_Download()
		...
		if false is YesNo('Are you sure you want to cancel all downloads?',
			...
			return
		.tasks.Members().Each(SuJsDownload.DeleteTask)
		.Refresh()
		}
	...
	Destroy()
		{
		Suneido.Delete(#SuJsDownloadAlertWindow)
		super.Destroy()
		}
	}