...
Test
	...
	Test_delays()
		...
		mock.SuTimerManager_mutex = Mutex()
		...
		mock.Verify.Times(2).recordAction([anyArgs:])
		...
		Assert(mock.SuTimerManager_delayQueue
			is: #(
				(id: 6, action: (false, #SuSetTimer, (6, 6, 2000, false)))
				(id: 5, action: (false, #SuKillTimer, (5, 5)))))
		Assert(mock.SuTimerManager_timers is: Object(2: cb, 6: false))
		}
	}