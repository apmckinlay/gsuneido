...
Controller
	...
	makecontrols()
		...
		try
			suneido = [#Image,
				MustQuery1(#suneidoc, name: "suneido.gif").text]
		catch
			suneido = #(Horz,
	...
	layout(suneido)
		{
		return [#Vert,
				[#Horz, #Fill, suneido, #Fill],
				#(Skip, 5),
				[#Horz, #Fill,
					[#Static, "Integrated Application Platform" size: "+5"], #Fill],
				#(Skip, 5),
				[#Horz, #Fill,
					[#Static, "Running from " $ ExePath()], #Fill],
				[#Horz, #Fill, [#Static, "Built: " $ Built()], #Fill],
				#(Skip, 5),
				#(Horz, Fill,
					(Static, "Licensed under the GNU General Public License Version 2"),
					Fill),
				[#Horz, #Fill,
					[#Static,
						"Copyright \xa9 2000-" $ Date().Year() $
							" Suneido Software Corp."],
					#Fill],
				...
				#(Horz, Fill,
					(WebLink, "hunspell.sourceforge.net", "hunspell.sourceforge.net/"),
					Fill),
				#(Skip, 5)].
			Add(.contributors())
		}
	...
	contributors()
		...
		return [#GroupBox, #Contributors,
			[#Vert,
				[#Scroll,
					[#Horz,
						#Fill,
						[#Static, firstnames justify: #RIGHT],
						#Skip,
						[#Static, lastnames],
						#Fill]
