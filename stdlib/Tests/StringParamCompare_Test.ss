...
Test
	...
	Test_All()
		{
		Assert(StringParamCompare(Record(), ''))
	...
	Test_Equals()
		...
		Assert(StringParamCompare(param, '110'))
		}
	Test_InList()
		{
		param = Object(operation: "in list",
			value2: "",
			value: #("100", "101", "105"))
		Assert(StringParamCompare(param, '100'))
	...
	Test_Range()
		...
		Assert(StringParamCompare(param, '100'))
		Assert(StringParamCompare(param, '101'))
		Assert(StringParamCompare(param, '105'))
		Assert(StringParamCompare(param, '110') is: false)
	...
	Test_Empty()
		...
		Assert(StringParamCompare(param, ''))
		Assert(StringParamCompare(param, '100') is: false)
	...
	Test_GreaterThan()
		...
		Assert(StringParamCompare(param, '100') is: false)
		Assert(StringParamCompare(param, '110') is: false)
		Assert(StringParamCompare(param, '120'))
		Assert(StringParamCompare(param, '99'))
	...
	Test_Contains()
		...
		Assert(StringParamCompare(param, '2110abc'))
		...
		Assert(StringParamCompare(param, '21105abc'))
		}
	Test_Matches()
		{
	...
	Test_StartEndWith()
		...
		Assert(StringParamCompare(param, '1251'))
		Assert(StringParamCompare(param, '1255'))
		...
		Assert(StringParamCompare(param, '4225'))
		Assert(StringParamCompare(param, '4325'))
		}
	Test_Unhandled()
		{
