...
//
// NOTE: this should be identical to ChooseTwoListEditorControl
// other than the base class is Field instead of Editor.
//
FieldControl
	{
	New(list, width, style = 0, mandatory = false, .listField = false,
		font = "", readonly = false, .delimiter = ',')
		{
		super(:width, :style, :mandatory, :font, :readonly)
