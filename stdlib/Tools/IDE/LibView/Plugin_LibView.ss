	...
	Contributions: (
		(LibView, Tools, Find_References_to_Current, R, "Ctrl+R",
			target: function(libview)
				{
				FindReferencesControl(libview.CurrentName())
				}),
		(LibView, Tools, Go_To_Documentation, D,
			target: function(libview)
				{
				GotoDocumentation(libview.CurrentName())
				}),
		(LibView, Tools, Run_Associated_Tests, T, "Ctrl+T",
			target: function(libview)
				{
				RunAssociatedTests.FromLibView(libview)
				}),
		...
		(LibView, Tools, Svc_Statistics, "",
			target: function(libview)
				{
				SvcStatsDisplay(libview.CurrentName(),
		...
		(LibView, Tools, BuiltDate_Tag, "",
			target: function(libview)
				{
				BuiltDateTag.Edit(libview)
				}),
