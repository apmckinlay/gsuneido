...
Test
	...
	Test_main()
		...
		cl = LocalTime
			{
			LocalTime_gmtTime() { return _gmtTime }

			LocalTime_timeZoneRec(stateProv) { return _timeZoneRec[stateProv] }

			LocalTime_defaultTime() { return _defaultTime }
			}
		func = cl
		...
		// MB "without" DST (they are permanently CDT after Nov. 1 2026)
		stateProv = #MB
		timezone = #CST
		Assert(func(stateProv, timezone) is: _gmtTime.Plus(hours: -5))
		// MN without DST
	...
	Test_DaylightSavings?()
		...
		Assert(func(#20191103.0659, timezone))
		Assert(func(#20191103.0700, timezone) is: false)
		Assert(func(#20191103.1000, timezone) is: false)
		...
		Assert(func(#20200308.0759, timezone) is: false)
		Assert(func(#20200308.0800, timezone))
		Assert(func(#20200615, timezone))
		Assert(func(#20200701, timezone))
		Assert(func(#20201031, timezone))
		Assert(func(#20201101, timezone))
		Assert(func(#20201101.0659, timezone))
		Assert(func(#20201101.0700, timezone) is: false)
		...
		gmtTime = #20260308.0100
		Assert(func(gmtTime, timezone) is: false)
		gmtTime = #20260308.0759
		Assert(func(gmtTime, timezone) is: false)
		gmtTime = #20260308.075959
		Assert(func(gmtTime, timezone) is: false)
		gmtTime = #20260308.0800
		Assert(func(gmtTime, timezone))
		gmtTime = #20260308.080001
		Assert(func(gmtTime, timezone))
		gmtTime = #20260308.1000
		Assert(func(gmtTime, timezone))
		gmtTime = #20260309.1000
		Assert(func(gmtTime, timezone))

		// more edge cases for November roll back
		gmtTime = #20261101.0100
		Assert(func(gmtTime, timezone))
		gmtTime = #20261101.0659
		Assert(func(gmtTime, timezone))
		gmtTime = #20261101.065959
		Assert(func(gmtTime, timezone))
		gmtTime = #20261101.0700
		Assert(func(gmtTime, timezone) is: false)
		gmtTime = #20261101.070001
		Assert(func(gmtTime, timezone) is: false)
		gmtTime = #20261101.0701
		Assert(func(gmtTime, timezone) is: false)
		gmtTime = #20261101.0900
		Assert(func(gmtTime, timezone) is: false)
		}
	}
