...
Test
	...
	Test_Compile()
		...
		Assert(Suneido.Compile("123") is: 123)
		Assert(Suneido.Compile("(1 2)") is: #(1, 2))
		Assert(Function?(Suneido.Compile("function () { }")))
		Assert(Class?(Suneido.Compile("class { F() { } }")))
		}
	...
	Test_Match()
		...
		Assert("Hello World".Match("lo ") is: [[3, 3]])
	...
	Test_string_coerce()
		{
		s = ""
		s = "" // prevent executing at compile time
