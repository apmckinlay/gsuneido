...
// It returns a new InfoChain. It does not modify the original.
...
func (c *InfoChain) WriteChain(store *stor.Stor) (uint64, InfoChain) {
	no := len(c.offs)
